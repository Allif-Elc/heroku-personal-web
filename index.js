...
app.get('/', (req,res)=>{
    db.connect(function(err,client,done){
        ...
        client.query('SELECT * FROM experience_info',function(err,result){
            done();
...
app.post('/',(req,res)=>{
    db.connect(function(err,client,done){
        if (err) throw err;
        let query = `INSERT INTO experience_info(experience,year) VALUES ('${req.body.experience}','${req.body.year}')`;
...
app.post('/blog',upload.single('image'),(req,res)=>{
    ...
    db.connect(function(err,client,done){
        if (err) throw err;
        let query = `INSERT INTO blog(title,content,image,author_id) 
